...
@section('content')
    ...
    <div class="container mx-auto px-5 py-5">
        ...
        <div class="mt-5">
            <a href="{{route('admin.posts.create')}}" class="btn btn-dark"> Create Post</a>
        </div>
                    ...
                    @foreach($posts as $post)
                        <tr>
                            <td class="px-5 py-4 text-nowrap border-bottom border-secondary">
                                <div class="text-sm-start text-secondary">{{$post->title}}</div>
                            </td>
                            <td class="px-5 text-nowrap text-end border-bottom border-secondary fs-3 ">
                                <a href="{{route('admin.posts.edit', $post->id)}}" class="btn btn-light">Update</a>
